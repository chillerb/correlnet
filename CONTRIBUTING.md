...
Welcome to `correlnet` contributor's guide.
...
If you experience bugs or general issues with `correlnet`, please have a look
...
You can help improve `correlnet` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`correlnet` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `correlnet`'s files. While this mechanism can
...
```
conda create -n correlnet python=3 six virtualenv pytest pytest-cov
conda activate correlnet
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/correlnet.git
   cd correlnet
   ```
...
5. Install [pre-commit]:
   ...
   `correlnet` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/correlnet
[issue tracker]: https://github.com/<USERNAME>/correlnet/issues
