...
Welcome to `correlgraph` contributor's guide.
...
If you experience bugs or general issues with `correlgraph`, please have a look
...
You can help improve `correlgraph` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`correlgraph` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `correlgraph`'s files. While this mechanism can
...
```
conda create -n correlgraph python=3 six virtualenv pytest pytest-cov
conda activate correlgraph
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/correlgraph.git
   cd correlgraph
   ```
...
5. Install [pre-commit]:
   ...
   `correlgraph` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/correlgraph
[issue tracker]: https://github.com/<USERNAME>/correlgraph/issues
